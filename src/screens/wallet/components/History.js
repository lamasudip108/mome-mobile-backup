...
const History = (props) => {
    ...
    const historyOptions = [
        {id: 1, icon: 'https://bootdey.com/img/Content/avatar/avatar1.png', first_name: 'Abdul', last_name: 'Bari', type:'request', amount:'100'},
        {id: 2, icon: 'https://bootdey.com/img/Content/avatar/avatar2.png', first_name: 'Abdul', last_name: 'Basit', type:'request', amount:'1000'},
        {id: 3, icon: 'https://bootdey.com/img/Content/avatar/avatar3.png', first_name: 'Abdul', last_name: 'Fattah', type:'send', amount:'500'},
        {id: 4, icon: 'https://bootdey.com/img/Content/avatar/avatar4.png', first_name: 'Abdul', last_name: 'Ghaffar', type:'request', amount:'50'},
        {id: 5, icon: 'https://bootdey.com/img/Content/avatar/avatar5.png', first_name: 'Abdul', last_name: 'Bari', type:'send', amount:'100'},
        {id: 6, icon: 'https://bootdey.com/img/Content/avatar/avatar6.png', first_name: 'Abdul', last_name: 'Basit', type:'send', amount:'1000'},
        {id: 7, icon: 'https://bootdey.com/img/Content/avatar/avatar1.png', first_name: 'Abdul', last_name: 'Fattah', type:'request', amount:'500'},
        {id: 8, icon: 'https://bootdey.com/img/Content/avatar/avatar2.png', first_name: 'Abdul', last_name: 'Ghaffar', type:'send', amount:'50'},
        {id: 9, icon: 'https://bootdey.com/img/Content/avatar/avatar3.png', first_name: 'Abdul', last_name: 'Bari', type:'send', amount:'100'},
    ];
    ...
    const renderItem = ({item}) => (
        ...
        <View style={styles.item}>
            <View style={styles.itemInner}>
                ...
                <Text style={styles.itemText}>{i18n.t('type')}: {item.type}</Text>
                <Text style={styles.itemText}>{i18n.t('amountlower')}: {item.amount}</Text>
                </View>
            </View>
            <View>
                {item.type === 'request' &&
